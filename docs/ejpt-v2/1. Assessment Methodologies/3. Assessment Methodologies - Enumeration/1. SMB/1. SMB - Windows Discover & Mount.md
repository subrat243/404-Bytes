...
1. **Enumerate SMB Services and OS Information**
    ...
    - **Purpose:** Scan the common SMB ports (`139` and `445`), detect service versions, and fingerprint the OS. See for commands [[04.Nmap - OS and Service Version Scanning]].
    - **Example Output:**
...
2. **Check SMB Security and Configuration**
    ...
    - **Purpose:** Check whether SMB message signing is enabled (critical for secure communication). See for commands [[12.Nmap - Nmap Scripting Engine]].
    - **Example Output:**
...
3. **List SMB Shares**
    ...
    - **Purpose:** List available SMB shares on the target system. See for commands [[12.Nmap - Nmap Scripting Engine]].
    - **Example Output:**
...
4. **User Enumeration over SMB**
    ...
    - **Purpose:** Enumerate user accounts on the target system via SMB. See for commands [[12.Nmap - Nmap Scripting Engine]].
    - **Example Output:**
